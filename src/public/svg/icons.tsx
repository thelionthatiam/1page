...
export function VideoIcon(props) {
    ...
    return (
        <svg className={props.styles}
            id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
            <title>repository-icon-video</title>
            <rect x="38" y="104.13" width="180.73" height="180.73" />
            <polygon points="362 119.56 362 271.64 219.26 195.6 362 119.56" />
            </svg>
    )
}

export function AFrameIcon(props) {

    return (
        <svg className={props.styles}
            id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400"
        >
            <title>repository-icon-a-frame</title>
            <polygon points="211.12 153.97 140.25 203.42 221.01 234.73 153.43 280.88 230.9 310.55 371 214.96 211.12 153.97" />
            <polyline points="43 234.73 89.15 150.67 123.76 266.05" />
            <polyline points="89.15 150.67 189.69 81.45 211.12 153.97" />
        </svg>
    )
}

export function CrowdIcon(props) {

    return (
        <svg className={props.styles}
            id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400"
        >
            <title>repository-icon-crowd</title>
            <circle cx="82.48" cy="121.61" r="42.96" />
            <circle cx="187.98" cy="121.61" r="42.96" />
            <circle cx="293.44" cy="121.61" r="42.96" />
            <polyline points="30 247.38 83.27 196.43 134.23 247.38 187.5 196.43 240.77 247.38 294.04 196.43 345 247.38" />
            <polyline points="30 321.5 83.27 270.55 134.23 321.5 187.5 270.55 240.77 321.5 294.04 270.55 345 321.5" />
            </svg>
    )
}
...
export function X(props) {
    return (
        <svg className={props.styles} viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" onClick = {props.onClick} onMouseOver = {props.onMouseOver} onMouseLeave = {props.onMouseLeave}>
            <line 
                x1="1" 
                y1="11"
                x2="11" 
...
export function Hamburger(props) {
    return (
        <div className= {props.class === "menu-svg open" ? "menu-icon-open":"menu-icon"} onClick = {props.openMenu}>
            <svg className = {props.class} width="24" height="24" id="hamburger" viewBox="0 0 24 16">
                <line className="a" fill="none" strokeWidth="2" x1="0" y1="1" x2="24" y2="1" />
                <line className="b" fill="none" strokeWidth="2" x1="0" y1="8" x2="24" y2="8" />
                <line className="c" fill="none" strokeWidth="2" x1="0" y1="15" x2="24" y2="15" />
            </svg>
        </div>
    )
}
...
export function CurrentWork(props) {
    return (
        <svg className = {props.class} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 400 400" >
            <g>
                <g>
                    <path d="M15.4,246.4c15.2-27.6,30.4-55.3,45.6-82.9c2.2-3.9,4.3-7.9,6.5-11.8c2.3-4.2-4.1-8-6.5-3.8 c-15.2,27.6-30.4,55.3-45.6,82.9c-2.2,3.9-4.3,7.9-6.5,11.8C6.6,246.8,13.1,250.6,15.4,246.4L15.4,246.4z"/>
                </g>
            </g>
            <g>
                <g>
                    <path d="M60.6,150.7c11.6,38.3,23.1,76.7,34.7,115c1.6,5.3,3.2,10.7,4.8,16c1.4,4.6,8.6,2.6,7.2-2c-11.6-38.3-23.1-76.7-34.7-115 c-1.6-5.3-3.2-10.7-4.8-16C66.4,144.1,59.2,146.1,60.6,150.7L60.6,150.7z"/>
                </g>
            </g>
            <g>
                <g>
                    <path d="M66.6,151.3c32.9-22.9,65.7-45.7,98.6-68.6c4.6-3.2,9.2-6.4,13.7-9.6c3.9-2.7,0.2-9.2-3.8-6.5 c-32.9,22.9-65.7,45.7-98.6,68.6c-4.6,3.2-9.2,6.4-13.7,9.6C58.9,147.5,62.7,154,66.6,151.3L66.6,151.3z"/>
                </g>
            </g>
            <g>
                <g>
                    <path d="M176.8,68.8c8.1,26.7,16.1,53.5,24.2,80.2c1.4,4.6,8.6,2.6,7.2-2c-8.1-26.7-16.1-53.5-24.2-80.2 C182.7,62.2,175.4,64.2,176.8,68.8L176.8,68.8z"/>
                </g>
            </g>
            <g>
                <g>
                    <path d="M126.6,210.5c23.4-16.3,46.9-32.6,70.3-48.9c3.4-2.4,6.8-4.7,10.2-7.1c3.9-2.7,0.2-9.2-3.8-6.5 c-23.4,16.3-46.9,32.6-70.3,48.9c-3.4,2.4-6.8,4.7-10.2,7.1C118.9,206.7,122.7,213.3,126.6,210.5L126.6,210.5z"/>
                </g>
            </g>
            <g>
                <g>
                    <path d="M204.3,154.9c20.5,7.9,41,15.8,61.6,23.7c32.9,12.7,65.8,25.3,98.7,38c7.5,2.9,15,5.8,22.5,8.7c4.5,1.7,6.5-5.5,2-7.2 c-20.5-7.9-41-15.8-61.6-23.7c-32.9-12.7-65.8-25.3-98.7-38c-7.5-2.9-15-5.8-22.5-8.7C201.7,145.9,199.8,153.2,204.3,154.9 L204.3,154.9z"/>
                </g>
            </g>
            <g>
                <g>
                    <path d="M231.8,335.3c17.9-12.4,35.8-24.8,53.6-37.3c28.3-19.7,56.6-39.4,85-59.1c6.5-4.5,13-9.1,19.6-13.6 c3.9-2.7,0.2-9.2-3.8-6.5c-17.9,12.4-35.8,24.8-53.6,37.3c-28.3,19.7-56.6,39.4-85,59.1c-6.5,4.5-13,9.1-19.6,13.6 C224,331.5,227.8,338,231.8,335.3L231.8,335.3z"/>
                </g>
            </g>
            <g>
                <g>
                    <path d="M123.1,211.7c26.2,10.1,52.4,20.2,78.5,30.2c3.7,1.4,7.5,2.9,11.2,4.3c4.5,1.7,6.5-5.5,2-7.2 c-26.2-10.1-52.4-20.2-78.5-30.2c-3.7-1.4-7.5-2.9-11.2-4.3C120.6,202.7,118.7,210,123.1,211.7L123.1,211.7z"/>
                </g>
            </g>
            <g>
                <g>
                    <path d="M141.2,299.6c22.1-15.3,44.1-30.6,66.2-46c3.2-2.2,6.4-4.5,9.6-6.7c3.9-2.7,0.2-9.2-3.8-6.5c-22.1,15.3-44.1,30.6-66.2,46 c-3.2,2.2-6.4,4.5-9.6,6.7C133.5,295.9,137.2,302.4,141.2,299.6L141.2,299.6z"/>
                </g>
            </g>
            <g>
                <g>
                    <path d="M137.7,300.9c26.1,10,52.2,20.1,78.2,30.1c3.8,1.5,7.5,2.9,11.3,4.4c4.5,1.7,6.5-5.5,2-7.2c-26.1-10-52.2-20.1-78.2-30.1 c-3.8-1.5-7.5-2.9-11.3-4.4C135.2,292,133.3,299.2,137.7,300.9L137.7,300.9z"/>
                </g>
            </g>
        </svg>
    )
...
export function About(props) {
    return (
        <svg className = {props.class} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            viewBox="0 0 400 400">
            <g>
                <circle cx="200" cy="200" r="189.5"/>
                {/* <path d="M200,11c25.5,0,50.3,5,73.6,14.9c22.5,9.5,42.7,23.1,60.1,40.5c17.4,17.4,31,37.6,40.5,60.1
...
export function Repository(props) {
    return (
        // <a href = '/photo'>
            <svg className = {props.class} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 400 400" onClick = {props.onClick}>
                <polyline points="28,389 200,13 371,389 " />
            </svg>
        // </a>
    )
}
...
export function LeftArrow(props) {
    return (
        <svg className = {props.style} viewBox="0 0 50 80" >
            <polyline className={props.style} fill="none" /*stroke-linecap="round" stroke-linejoin="round"*/ points="45.63,75.8 0.375,38.087 45.63,0.375 "/>
        </svg>  
...
export function RightArrow(props) {
    return (
        <svg className = {props.style} xmlns="http://www.w3.org/2000/svg"  width="60px" height="80px" viewBox="0 0 50 80">
            <polyline className = {props.style} fill="none" stroke="#FFFFFF" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" points="0.375,0.375 45.63,38.087 0.375,75.8 "/>
        </svg>
