...
function PasswordQuality(props) {
  ...
  if (props.entropy > 0 ) {
    entropyReport = <p className = 'fadeIn textError marginPaddingFix'> {"Not strong enough. Entropy: " + props.entropy} </p>
  }
  if (props.entropy > 59) {
    passIndicator.background = '#068721'
    entropyReport = <p className = 'fadeIn textSuccess marginPaddingFix'> {"This should be strong enough. Entropy: " + props.entropy} </p>
  }
