                ...
                react_1.default.createElement("div", { className: 'app-wrapper' },
                    react_1.default.createElement("ul", { className: "app-menu" },
                        ...
                        react_1.default.createElement("li", { className: 'app-menu-li' },
                            ...
                            react_1.default.createElement(react_router_dom_1.Link, { to: "/orgs", className: 'app-menu-text ' }, "organizations")),
                        react_1.default.createElement("li", { className: 'app-menu-li' },
                            react_1.default.createElement("img", { className: 'formIcon fadeIn', src: '/icons/white/graph-bar.svg' }),
                            react_1.default.createElement(react_router_dom_1.Link, { to: "/insights", className: 'app-menu-text-disabled disabled-link' }, "insights")),
                        react_1.default.createElement("li", { className: 'app-menu-li' },
                            react_1.default.createElement("img", { className: 'formIcon fadeIn', src: '/icons/white/user-fem.svg' }),
                            react_1.default.createElement(react_router_dom_1.Link, { to: "/profile", className: 'app-menu-text-disabled disabled-link' }, "profile")),
                        react_1.default.createElement("li", { className: 'app-menu-li' },
                            react_1.default.createElement("img", { className: 'formIcon fadeIn', src: '/icons/white/mixer.svg' }),
                            react_1.default.createElement(react_router_dom_1.Link, { to: "/settings", className: 'app-menu-text-disabled disabled-link' }, "settings")),
                    ...
                    react_1.default.createElement("div", { className: "app-content" },
                        ...
                        react_1.default.createElement(react_router_dom_1.Route, { path: '/alarms', component: alarm_actions_1.default }),
                        react_1.default.createElement(react_router_dom_1.Route, { path: '/orgs', component: organizations_1.default }),
