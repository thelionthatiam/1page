...
var FormWrapper = (function (_super) {
    ...
    FormWrapper.prototype.render = function () {
        ...
        return (React.createElement("div", {className: 'formWrapper'}, React.createElement("form", {onSubmit: this.handleSubmit, action: this.props.url, method: this.props.method}, childWithProp, React.createElement(Button, {submitable: this.state.submitable, submitted: this.state.submitted, onClick: this.handleSubmit, buttonText: this.props.buttonText, type: 'submit'}))));
    };
    return FormWrapper;
}(React.Component));
