var a = (function (exports) {
	...
	*/
	...
	var reactDom_3 = reactDom.unmountComponentAtNode;
	...
	*/
	            ...
	            return this.props.isOpen
	                ?
	                    react_4("div", {className: 'lightbox-wrapper', scroll: "no"}, react_4("div", {className: 'lightbox-title-wrapper'}, react_4(PhotoIcon, {styles: this.state.rendered
	                        ...
	                        :
	                            'svg-icon lightbox-icon'})), react_4("div", {className: 'lightbox-left-paddle', onClick: this.props.gotoPrevious, onMouseOver: this.hideX}, react_4("div", {className: 'left-triangle'})), react_4(Swipe, {onSwipeStart: this.onSwipeStart, onSwipeMove: this.onSwipeMove, onSwipeEnd: this.onSwipeEnd}, react_4("div", {className: 'lightbox-photo-wrapper', onClick: this.props.onClose}, react_4("img", {className: 'lightbox-img', src: img, id: this.props.currentImage, onMouseOver: this.showX, onMouseLeave: this.hideX}))), react_4("div", {className: 'lightbox-right-paddle', onClick: this.props.gotoNext, onMouseOver: this.hideX}, react_4("div", {className: 'right-triangle'})), react_4(X, {styles: this.state.xStyle, onClick: this.props.onClose, onMouseOver: this.showX, onMouseLeave: this.hideX}), react_4(DotBox, {photos: this.props.photos, gotoSelected: this.props.gotoSelected, currentImage: this.props.currentImage}))
	                :
	                    null;
	        }
	    };
	...
	var Dial = (function (_super) {
	    ...
	    Dial.prototype.render = function () {
	        ...
	        var showSelected = (react_4("a", {href: selected[0].link, className: 'selected-repository'}, react_4(SelectedIcon, {styles: 'r-menu-icons selected'}), react_4("p", {className: 'r-menu-titles'}, selected[0].title)));
	...
	var ErrorBoundary = (function (_super) {
	    ...
	    ErrorBoundary.prototype.render = function () {
	        if (this.state.hasError) {
	            return react_4("h1", null, "Something went wrong.");
	        }
