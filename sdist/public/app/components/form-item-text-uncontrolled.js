...
var TextFormUnc = /** @class */ (function (_super) {
    __extends(TextFormUnc, _super);
    function TextFormUnc(props) {
    ...
    TextFormUnc.prototype.render = function () {
        return (React.createElement("div", { className: 'textFormWrapper' },
            ...
            React.createElement("div", null,
                ...
                React.createElement(TextInput, { firstClick: this.state.firstClick, clicked: this.state.clicked, onClick: this.handleClick, onFocus: this.handleFocus, onChange: this.handleChange, blurred: this.handleBlur, placeholder: this.props.placeholder, submitted: this.props.submitted, error: this.state.error })),
            React.createElement(FormError, { error: this.state.error, errorMessage: this.state.errorMessage })));
    };
    TextFormUnc.prototype.handleChange = function (event) {
        this.setState({
    ...
    TextFormUnc.prototype.handleFocus = function () {
        console.log('sup');
    ...
    TextFormUnc.prototype.handleBlur = function (event) {
    ...
    TextFormUnc.prototype.handleClick = function (event) {
        this.setState({
            firstClick: true,
            clicked: true,
            focused: true,
    ...
    TextFormUnc.prototype.componentDidMount = function () {
...
var TextInput = /** @class */ (function (_super) {
    ...
    TextInput.prototype.render = function () {
        ...
        return (React.createElement("div", { className: currentClass },
            React.createElement("input", { type: 'text', placeholder: this.state.placeholder, onFocus: this.props.test, onChange: this.props.onChange, onClick: this.props.onClick, onBlur: this.props.blurred, onFocus: this.props.onFocus, ref: function (input) { return _this.input = input; } })));
    };
    return TextInput;
}(React.Component));
...
exports.default = TextFormUnc;
//# sourceMappingURL=form-item-text-uncontrolled.js.map