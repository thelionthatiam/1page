...
function newAccount() {
    return ReactDOM.render(React.createElement(form_wrapper_1.default, { buttonText: 'create new account', url: 'http://localhost:8000/accounts' },
        ...
        React.createElement(form_item_password_1.default, { title: 'password', placeholder: 'type in your password' })), document.getElementById('new-user'));
}
