...
var SettingsSvc = /** @class */ (function () {
    ...
    SettingsSvc.prototype.changeAlarmPrices = function () {
        var _this = this;
        return this.changeMonthMax()
            .then(function () { return _this.changePricePerDismiss(); })
            .then(function () { return _this.changePricePerSnooze(); })
            .then(function () { return _this.changePricePerWake(); });
    };
    SettingsSvc.prototype.changeAlarmSettings = function () {
        var _this = this;
        return this.changeQuietAfter()
            .then(function () { return _this.changeSnoozeDuration(); });
    };
    ...
    SettingsSvc.prototype.changePricePerWake = function () {
        var _this = this;
        return this.querySvc.getUserSettings([this.user.uuid])
            .then(function (result) {
            // validation
            return _this.querySvc.updatePricePerWake([_this.inputs.wake_price, _this.user.uuid]);
        });
    };
