...
router.use('/guest', require('./guest/authorization'));
router.use('/guest', require('./guest/email'));
router.use('/guest', require('./guest/accounts'));
router.use('/guest', require('./guest/shopping'));
router.use('/guest', require('./guest/organizations'));
