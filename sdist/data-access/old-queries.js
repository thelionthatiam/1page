...
var Query = /** @class */ (function () {
    ...
    Query.prototype.insertUser = function (values) {
        var query = 'INSERT INTO users(email, phone, password, name, permission) VALUES($1, $2, $3, $' +
            '4, $5) RETURNING *';
        return this
            .conn
            .query(query, values);
    ...
    Query.prototype.insertSnooze = function (values) {
        var query = 'INSERT INTO snooze(user_uuid, alarm_uuid, recipient, org_trans_total, sent) VALU' +
            'ES ($1, $2, $3, $4, $5)';
        return this
            .conn
            .query(query, values);
    ...
    Query.prototype.insertTransaction = function (values) {
        var query = 'INSERT INTO transactions(user_uuid, recipient, payment_uuid, snoozes, dismisses,' +
    ...
    Query.prototype.insertOrgPayment = function (values) {
        var query = 'INSERT INTO org_transactions(trans_uuid, user_uuid, recipient, org_trans_total, ' +
    ...
    Query.prototype.insertRevenue = function (values) {
        var query = 'INSERT INTO revenue(trans_uuid, user_uuid, trans_revenue_total) VALUES ($1, $2, ' +
            '$3)';
        return this
            .conn
            .query(query, values);
...
exports.Query = Query;
;
//# sourceMappingURL=old-queries.js.map